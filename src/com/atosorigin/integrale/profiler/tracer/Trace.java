...
public class Trace implements Runnable {
    ...
    private static String[] excludes = {"java.*", "javax.*", "sun.*",
                                 "com.sun.*", "com.thoughtworks.*", "org.xmlpull.*"};
    ...
    Trace(String[] args) {
        ...
        for (inx = 0; inx < args.length; ++inx) {
            ...
            if (arg.charAt(0) != '-') {
            	try {
            		writer = new PrintWriter(new FileWriter(new File("./res/out/trace.trc")));
            	} catch (IOException ioe) {
            		System.err.println("Cannot open output file: " + args[inx] + " - " +  ioe);
            		System.exit(1);
            	}
                break;
...
"  -help                Print this help message");
	...
	public static void setExclusions(String[] ex) {
